...
import model.world.Champion;import model.world.Condition;
...
public void setListener(GameListener k) {
	listener=k;
}
	...
	public void castAbility(Ability a, int x, int y) throws NotEnoughResourcesException, AbilityUseException,
		...
		if(x<0||x>4)
			return;
		if(y<0||y>4)
			throw new InvalidTargetException("You can not cast an ability on an non existed cell");
		if (board[x][y] == null)
